...
###INPUT ARGUMENTS ######################################################
my $inputdir = "/p8/mcc_y95/fmobegi/2019-09-26-Pacbio_AGRF_rabiei/01-datacleaning"; 
my $outdir = "/p8/mcc_y95/fmobegi/2019-09-26-Pacbio_AGRF_rabiei/02-assembly";

### CHANGE VALUES AS PER NEED ##########################################
my $username = "fredrick.mobegi"; ## curtin university email. Not implemented at the moment
my $jobname = "canu2";
my $nodes = 1;
...
my $cmdline = "canu -p PREFIX -d outdir\/PREFIX\/CANU2_ASSEMBLY useGrid=false corThreads=24 genomeSize=45m -pacbio-raw input1";
...
opendir(DIR,$inputdir) or die print "Provide input folder containing PacBio sequenced reads for assembly.\n$!"; 
my %files=(); 
my %file_PREFIX=();
